...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == "private":
            ...
            if grpid is not None:
                ...
                return await query.answer('тнє6σ')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('❣ 𝙶𝚛𝚘𝚞𝚙 ❣', url='https://t.me/MoviePalace_Chat')
        ], [
            InlineKeyboardButton('⌂ Home ⌂', callback_data='start'),
        ...
        buttons = [[
            InlineKeyboardButton('⬽', callback_data='help'),
            InlineKeyboardButton('♛ ΛDMIП', callback_data='admin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            ...
            pic = imdb.get('poster')
            poster = pic.replace('.jpg', "https://telegra.ph/file/948334c2554e94818679e.jpg")
...
async def advantage_spell_chok(msg):
    ...
    btn.append([InlineKeyboardButton('❖𝐆𝐨𝐨𝐠𝐥𝐞 𝐈𝐭❖', url=f'https://www.google.com/search?q={search}')])
